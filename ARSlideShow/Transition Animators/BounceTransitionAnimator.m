...
//
//  Created by Adrian Russell on 30/12/2017.
...
- (void)startTransition:(void(^)(BOOL didComplete))completionHandler
{
    ...
    [UIView animateWithDuration:self.duration delay:0.0 usingSpringWithDamping:0.6 initialSpringVelocity:1.0 options:kNilOptions animations:^{
